...
# Your task is to change the definition of simple_divide so that the call does not raise 
# an exception. When dividing by 0, fancy_divide should return a list with all 0 elements.
